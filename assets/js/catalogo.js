function catalogo1(){
    let catalogo1 = document.getElementById('no1').style.display = 'flex';
    let menu1 = document.getElementById('opt1').style.backgroundColor = '#FF66C4';

    let catalogo2 = document.getElementById('no2').style.display = 'none';
...
function catalogo2(){
    let catalogo1 = document.getElementById('no1').style.display = 'none';
